#!/usr/bin/env python3
"""
Flask app with i18n, user context, and timezones
...
- Timezone handling based on user preference or default
"""
...
class Config(object):
    """Configuration for Babel and timezones"""
    LANGUAGES = ["en", "fr"]
...
def get_timezone():
    ...
    tzone = request.args.get('timezone')  # Check URL parameter
    if tzone:
        try:
    ...
    return utc  # Use UTC as a safe fallback
